  ...
  return (
    <>
      ...
      >
        ...
        <h1 className="welcome" style={{ color: 'green' }}>Welcome, {regUser.firstName}!</h1>
      </div>
      ...
      <div className="text-center mt-2">
        ...
        <Link passHref href="/lists/new">
          <Button className="lstBtn btn btn-light me-2 border border-danger-subtle" style={{ color: 'green' }}>New List</Button>
        </Link>
        <Link passHref href="/giftees/new">
          <Button className=" giftBtn btn btn-light border border-danger-subtle" style={{ color: 'green' }}>New Giftee</Button>
        </Link>
      </div>
    </>
  );
